...
class Chat {
  ...
  final Map<String, String> participantEmails;  // Map of userId -> email for display
  ...
  factory Chat.fromFirestore(DocumentSnapshot doc) {
    ...
    if (data['participantPhotoURLs'] != null) {
      final photoURLsData = data['participantPhotoURLs'] as Map<String, dynamic>;
      photoURLs = photoURLsData.map((key, value) => MapEntry(key, value.toString()));
    }
